...
public class AdminRecipeListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Recipe> pageList = new RecipeService().selectAdminRecipeList(pi);
				
		request.setAttribute("pi", pi);
		request.setAttribute("pageList", pageList);
				
				
		request.getRequestDispatcher("views/member/adminRecipeListView.jsp").forward(request, response);
